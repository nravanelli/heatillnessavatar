<template>
  <v-card>
    ...
    <v-card-text class="plot-container">
      <div ref="plotlyContainer" class="plot-inner" hide-details="auto">
         <div v-if="shouldShowSlider" style="display: flex;">
          <p style="margin-left:50px; font-weight: 500;"> Number of Symptoms to show </p>
          <br>
            <v-slider
  ...
  methods: {
    ...
    async renderGraph(graphData, selectiondata) {
      try {
        ...
        //console.log(graphData.groupmap);
        const result = {};
